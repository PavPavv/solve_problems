...
[Теоретический минимум по алгоритмам](https://github.com/PavPavv/MyJSCheatsheet/blob/master/js-code/algorithms/algorihms_ru.md)
...
3. Связанный список
4. Массив связных списков (гибридная структура данных)
5. Стэк (FILO)
6. Очередь (FIFO)
7. Граф
8. Девевья, как частный случай графа
